...
<div class="flex flex-wrap items-center lg:items-end justify-between gap-5 pb-7.5">
    ...
    <div class="flex items-center gap-2.5">
        <a class="kt-btn kt-btn-outline" href="public-profile/profiles/default.html">View Profile</a>
    </div>
</div>
<div class="grid gap-5 lg:gap-7.5">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        <div class="kt-card p-4">
            <div class="text-sm text-secondary-foreground">Total Rooms</div>
            <div class="text-2xl font-semibold">{{ $totalRooms ?? 0 }}</div>
        </div>
        <div class="kt-card p-4">
            <div class="text-sm text-secondary-foreground">Available Rooms</div>
            <div class="text-2xl font-semibold">{{ $availableRooms ?? 0 }}</div>
        </div>
        <div class="kt-card p-4">
            <div class="text-sm text-secondary-foreground">Occupied Rooms</div>
            <div class="text-2xl font-semibold">{{ $occupiedRooms ?? 0 }}</div>
        </div>
        <div class="kt-card p-4">
            <div class="text-sm text-secondary-foreground">Out of Service</div>
            <div class="text-2xl font-semibold">{{ $outOfService ?? 0 }}</div>
        </div>
    </div>
    <div class="grid lg:grid-cols-3 gap-y-5 lg:gap-7.5 items-stretch">
        <div class="lg:col-span-1">
            <div class="grid grid-cols-2 gap-5 lg:gap-7.5 h-full items-stretch">
                <style>
                    .channel-stats-bg {
                        background-image: url(dist/assets/media/images/2600x1600/bg-3.png);
                    }
                    .dark .channel-stats-bg {
                        background-image: url(dist/assets/media/images/2600x1600/bg-3-dark.png);
                    }
                </style>
                <div
                ...
                >
                    <img
                        alt=""
                        class="w-7 mt-4 ms-5"
                        src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/linkedin-2.svg"
                    />
                    <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">9.3k</span
                        ><span class="text-sm font-normal text-secondary-foreground">Amazing mates</span>
                    </div>
                </div>
                <div
                    class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg"
                >
                    <img
                        alt=""
                        class="w-7 mt-4 ms-5"
                        src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/youtube-2.svg"
                    />
                    <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">24k</span
                        ><span class="text-sm font-normal text-secondary-foreground">Lessons Views</span>
                    </div>
                </div>
                <div
                    class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg"
                >
                    <img
                        alt=""
                        class="w-7 mt-4 ms-5"
                        src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/instagram-03.svg"
                    />
                    <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">608</span
                        ><span class="text-sm font-normal text-secondary-foreground">New subscribers</span>
                    </div>
                </div>
                <div
                    class="kt-card flex-col justify-between gap-6 h-full bg-cover rtl:bg-[left_top_-1.7rem] bg-[right_top_-1.7rem] bg-no-repeat channel-stats-bg"
                >
                    <img
                        ...
                        src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/tiktok.svg"
                    />
                    <img
                        alt=""
                        class="hidden dark:block w-7 mt-4 ms-5"
                        src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/tiktok-dark.svg"
                    />
                    <div class="flex flex-col gap-1 pb-4 px-5">
                        <span class="text-3xl font-semibold text-mono">2.5k</span
                        ><span class="text-sm font-normal text-secondary-foreground">Stream audience</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="lg:col-span-2">
            <style>
                .entry-callout-bg {
                    background-image: url(dist/assets/media/images/2600x1600/2.png);
                }
                .dark .entry-callout-bg {
                    background-image: url(dist/assets/media/images/2600x1600/2-dark.png);
                }
            </style>
                ...
                >
                    <div class="flex flex-col justify-center gap-4">
                        ...
                        <h2 class="text-xl font-semibold text-mono">
                            Connect Today &amp; Join<br />the<a class="kt-link" href="#">KeenThemes Network</a>
                        </h2>
                        <p class="text-sm font-normal text-secondary-foreground leading-5.5">
                            Enhance your projects with premium themes and<br />templates. Join the KeenThemes community
                            today<br />for top-quality designs and resources.
                        </p>
                    </div>
                </div>
            ...
            <div class="kt-card h-full">
                            ...
                            >
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="account/activity.html"
                                        ><span class="kt-menu-icon"><i class="ki-filled ki-cloud-change"></i></span
                                        ><span class="kt-menu-title">Activity</span></a
                                    >
                                </div>
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" data-kt-modal-toggle="#share_profile_modal" href="#"
                                        ...
                                        ><span class="kt-menu-title">Share</span></a
                                    >
                                </div>
                                <div
                                    class="kt-menu-item"
                                ...
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" data-kt-modal-toggle="#report_user_modal" href="#"
                                        ><span class="kt-menu-icon"><i class="ki-filled ki-dislike"></i></span
                                        ><span class="kt-menu-title">Report</span></a
                                    >
                                </div>
                                <div class="kt-menu-separator"></div>
                                <div class="kt-menu-item">
                                    <a class="kt-menu-link" href="account/home/settings-enterprise.html"
                                        ><span class="kt-menu-icon"><i class="ki-filled ki-setting-3"></i></span
                ...
                <div class="kt-card-content flex flex-col gap-4 p-5 lg:p-7.5 lg:pt-4">
                    <div class="flex flex-col gap-0.5">
                        <span class="text-sm font-normal text-secondary-foreground">All time sales</span>
                        <div class="flex items-center gap-2.5">
                            <span class="text-3xl font-semibold text-mono">$295.7k</span
                    ...
                    <div class="flex items-center flex-wrap gap-4 mb-1">
                        <div class="flex items-center gap-1.5">
                            <span class="rounded-full size-2 rounded-full kt-badge-success"></span
                            ><span class="text-sm font-normal text-foreground">Metronic</span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="rounded-full size-2 rounded-full kt-badge-destructive"></span
                            ><span class="text-sm font-normal text-foreground">Bundle</span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="rounded-full size-2 rounded-full kt-badge-info"></span
                            ><span class="text-sm font-normal text-foreground">MetronicNest</span>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-3">
                        <div class="flex items-center justify-between flex-wrap gap-2">
                            <div class="flex items-center gap-1.5">
                                ...
                                ><span class="text-sm font-normal text-mono">Online Store</span>
                            </div>
                            <div class="flex items-center text-sm font-medium text-foreground gap-6">
                                ...
                                ><span class="lg:text-right"
                                    ><i class="ki-filled ki-arrow-up text-green-500"></i>3.9%</span
                                >
                            </div>
                        </div>
                        <div class="flex items-center justify-between flex-wrap gap-2">
                            <div class="flex items-center gap-1.5">
                                ...
                                ><span class="text-sm font-normal text-mono">Facebook</span>
                            </div>
                            <div class="flex items-center text-sm font-medium text-foreground gap-6">
                                <span class="lg:text-right">$85k</span
                                ><span class="lg:text-right"
                                    ><i class="ki-filled ki-arrow-down text-destructive"></i>0.7%</span
                                >
                            </div>
                        </div>
                        <div class="flex items-center justify-between flex-wrap gap-2">
                            <div class="flex items-center gap-1.5">
                                ...
                                ><span class="text-sm font-normal text-mono">Instagram</span>
                            </div>
                            <div class="flex items-center text-sm font-medium text-foreground gap-6">
                                <span class="lg:text-right">$36k</span
                                ><span class="lg:text-right"
                                    ><i class="ki-filled ki-arrow-up text-green-500"></i>8.2%</span
                                >
                            </div>
                        </div>
                    </div>
                ...
                <div class="kt-card-header">
                    ...
                    <div class="flex gap-5">
                        <label class="flex items-center gap-2"
                            ><input class="kt-switch" name="check" type="checkbox" value="1" /><span class="kt-label"
                                >Referrals only</span
                            ></label
                        ><select
                ...
                <div class="kt-card-content lg:p-7.5 lg:pt-6 p-5">
                    <div class="flex items-center justify-between flex-wrap gap-5 mb-7.5">
                        <div class="flex flex-col gap-1">
                            <span class="text-xl font-semibold text-mono">Team Meeting</span
                            ><span class="text-sm font-semibold text-foreground">09:00 - 09:30</span>
                        </div>
                        <img
                            alt=""
                            class="size-7"
                            src="https://keenthemes.com/metronic/tailwind/dist/assets/media/brand-logos/zoom.svg"
                        />
                    </div>
                    <p class="text-sm font-normal text-foreground leading-5.5 mb-8">
                        Team meeting to discuss strategies, outline<br />project milestones, define key goals, and<br />establish
                        clear timelines.
                    </p>
                    <div class="flex rounded-lg bg-accent/50 gap-10 p-5">
                        <div class="flex flex-col gap-5">
                            <div class="flex items-center gap-1.5 text-sm font-normal text-foreground">
                                <i class="ki-filled ki-geolocation text-base text-muted-foreground"></i>Location
                            </div>
                            <div class="text-sm font-medium text-foreground pt-1.5">Amsterdam</div>
                        </div>
                        <div class="flex flex-col gap-5">
                            <div class="flex items-center gap-1.5 text-sm font-normal text-foreground">
                                <i class="ki-filled ki-users text-base text-muted-foreground"></i>Team
                            </div>
                            <div class="flex -space-x-2">
                                <div class="flex">
                                    <img
                                ...
                                <div class="flex">
                                    <span
                                        class="hover:z-5 relative inline-flex items-center justify-center shrink-0 rounded-full ring-1 font-semibold leading-none text-2xs size-[30px] text-white text-xs ring-background bg-green-500"
                                        >+10</span
                                    >
                                </div>
                            </div>
                                            ...
                                            <td>
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    ><span
                                                        ...
                                                        >Product development &amp; lifecycle</span
                                                    >
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    ><span
                                                        class="text-2sm text-secondary-foreground font-normal leading-3"
                                                        >Campaigns &amp; market analysis</span
                                                    >
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    ><span
                                                        class="text-2sm text-secondary-foreground font-normal leading-3"
                                                        >Talent acquisition, employee welfare</span
                                                    >
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="flex flex-col gap-2">
                                                    ...
                                                    ><span
                                                        class="text-2sm text-secondary-foreground font-normal leading-3"
                                                        >Customer relations, sales strategy</span
                                                    >
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-24.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-7.png"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-10.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-13.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-15.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-16.png"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    ...
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-19.png"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-22.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-23.png"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    ...
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-25.png"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-26.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-27.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-28.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <span
                                            ...
                                            <td>
                                                <div class="flex -space-x-2">
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-29.png"
                                                        />
                                                    </div>
                                                    <div class="flex">
                                                        <img
                                                            class="hover:z-5 relative shrink-0 rounded-full ring-1 ring-background size-[30px]"
                                                            src="../dist/assets/media/avatars/300-30.png"
                                                        />
                                                    </div>
                                                </div>
                                            </td>
