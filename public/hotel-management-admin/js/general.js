            ...
            value: function () {
              ...
              if (KTDom.getElement('#'.concat(t)) && L) {
                ...
                (L.marker([40.724716, -73.984789], { icon: a })
                  .addTo(r)
                  .bindPopup('430 E 6th St, New York, 10009.', { closeButton: !1 })
                  .openPopup(),
              ...
              var t = [
                ...
                e = {
                  ...
                  legend: {
                    ...
                    labels: { colors: 'var(--color-secondary-foreground)', useSeriesColors: !1 },
          ...
          },
          {
            ...
            value: function () {
              var t = [
                ...
                e = {
                  series: [
                    { name: 'series1', data: [85, 65, 50, 70, 40, 45, 100, 55, 85, 60, 70, 90] },
                  ],
                  chart: { height: 250, type: 'area', toolbar: { show: !1 } },
                  dataLabels: { enabled: !1 },
                  legend: { show: !1 },
                  stroke: { curve: 'smooth', show: !0, width: 3, colors: ['var(--color-primary)'] },
                  xaxis: {
                    categories: t,
                    axisBorder: { show: !1 },
                    maxTicks: 12,
                    axisTicks: { show: !1 },
                    labels: { style: { colors: 'var(--color-white)', fontSize: '12px' } },
                    crosshairs: {
                      position: 'front',
                  ...
                  fill: { gradient: { enabled: !0, opacityFrom: 0.25, opacityTo: 0 } },
                  grid: {
          ...
          },
          {
            ...
            value: function () {
              var t = [
                ...
                e = {
                  series: [
                    { name: 'series1', data: [75, 25, 45, 15, 85, 35, 70, 25, 35, 15, 45, 30] },
                  ],
                  chart: { height: 250, type: 'area', toolbar: { show: !1 } },
                  dataLabels: { enabled: !1 },
                  legend: { show: !1 },
              ...
              var t = [
                ...
                e = {
                  series: [
                    {
                      name: 'series1',
                      data: [70, 60, 75, 55, 35, 80, 100, 70, 90, 65, 50, 85, 60, 75, 65, 80],
                    },
                  ],
              ...
              switch (t.target.getAttribute('data-chart')) {
                case 'my_balance_chart1':
                  ((e = [45, 35, 45, 35, 55, 85, 20, 25, 55]),
                    (o = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep']));
                  break;
                ...
                case 'my_balance_chart3':
                  ((e = [80, 40, 50, 20, 50, 80, 60, 20, 30]),
                    (o = ['Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar']));
                  break;
