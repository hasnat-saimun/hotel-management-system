...
<div class="kt-card">
    <div class="kt-card-header flex items-center justify-between">
        <div>
            <h3 class="kt-card-title">Add Travel Agent</h3>
            <div class="text-sm text-secondary-foreground">Create agent profile</div>
        </div>
    ...
    <div class="kt-card-content p-4">
        ...
        <form method="POST" action="{{ route('admin.travel-agents.store') }}" class="grid gap-3 grid-cols-1 lg:grid-cols-2">
            @csrf
            ...
            <div>
                ...
                <input type="number" step="0.01" min="0" max="100" class="kt-input w-full" name="commission_percentage" value="{{ old('commission_percentage', 0) }}" />
            </div>
